...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/31 21:54:57 by oorlov            #+#    #+#             */
/*   Updated: 2019/07/31 21:54:58 by oorlov           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		resize_value(t_buff **buffer, t_arg *arg)
{
	...
	zero = ft_set_sym('0', arg->prec - ft_strlen((*buffer)->value));
...
void		buff_value(t_buff **buffer, t_arg *arg)
{
	if ((num_type(arg) || point_type(arg)) && arg->prec == 0 && arg_v(arg) == 0)
		...
		(*buffer)->value = char_type_set((arg->value)->schar);
